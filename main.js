...
let navigation = {
    // Variables
    $navTrigger: document.querySelector('.helper-menu__trigger'),
    $nav: document.querySelector('.helper-menu'),
    $navItems: document.querySelectorAll('.helper-menu__item a'),
